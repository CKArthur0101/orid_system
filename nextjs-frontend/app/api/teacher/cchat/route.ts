...
/** 教師 BFF：學生該週寫作教練對話紀錄。GET ?classId=&studentId=&week= */
export async function GET(req: NextRequest) {
  ...
  const r = await fetch(
    `${API_BASE_URL}/teacher/classes/${encodeURIComponent(classId)}/students/${encodeURIComponent(studentId)}/chat-messages?week=${encodeURIComponent(week)}`,
    {
      method: "GET",
      headers: {

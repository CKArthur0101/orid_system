...
/** Book 3 character-grounded questions for 《不會寫字的獅子》. */
const THINKING_GROUPS_BOOK3: Record<StageKey, string[][]> = {
  O: [
    ["故事一開始，獅子對「不會寫字」這件事有什麼想法？", "可以想一想獅子一開始覺得自己會做什麼就夠了。", "請寫故事中看得到的事情，不用先寫自己的感想。"],
    ["獅子看見母獅子在做什麼？這件事讓他想做什麼？", "可以注意母獅子和「看書」有關的情節。", "請把獅子看到母獅子後的反應寫清楚。"],
    ["獅子請哪些動物幫忙寫信或讀信？結果發生了什麼事？", "可以依照故事順序整理，不需要每隻動物都寫很長。", "請注意每封信的內容都和獅子真正想說的話不太一樣。"],
    ["故事最後，母獅子和獅子之間發生了什麼事？", "可以注意母獅子問了獅子什麼問題。", "請寫出獅子最後承認了什麼，以及後來開始做什麼。"],
  ],
  R: [
    ["看到獅子不會寫字，卻想寫信給母獅子，你有什麼感覺？", "可以寫替他緊張、覺得有趣、覺得可惜，或其他真實感覺。", "請說明你為什麼有這種感覺。"],
    ["當獅子發現每封信都不是自己想說的話時，你有什麼感覺？", "可以想一想，如果你的意思一直被別人誤會，你會怎麼樣。", "請把感覺和故事情節連在一起。"],
    ["看到獅子一次又一次大叫「不對！」時，你有什麼感覺？", "可以寫你覺得他可憐、好笑、著急，或覺得他需要幫忙。", "請不要只寫「很好看」，要說出原因。"],
    ["看到母獅子願意聽獅子說話，並陪他開始學認字，你有什麼感覺？", "可以想一想母獅子的反應帶給你什麼感受。", "請寫出讓你有這種感覺的原因。"],
  ],
  I: [
    ["你覺得這個故事想告訴我們，為什麼要學會表達自己的想法？", "可以從獅子請別人寫信卻一直失敗來想。", "請用自己的話說明，不用寫成標準答案。"],
    ["為什麼別的動物幫獅子寫信，卻沒有寫出獅子真正想說的話？", "可以想一想每隻動物是不是都把自己的生活方式寫進信裡。", "請說明這件事讓你想到什麼。"],
    ["獅子從「不在乎不會寫字」到「開始學認字」，這代表他有什麼改變？", "可以想一想他為什麼願意開始學習。", "請把故事中的改變說清楚。"],
    ["你有沒有遇過想說一件事，卻說不清楚或寫不清楚的時候？", "可以寫學校、家裡或和朋友相處時的經驗。", "請連結故事，不要只寫自己的事情。"],
  ],
  D: [
    ["如果以後你有重要的話想說，你可以怎麼讓別人更了解你？", "可以寫先整理想法、慢慢說、先寫草稿，或請別人幫你修改。", "請寫自己真的做得到的行動。"],
    ["如果你遇到自己不會的事情，可以怎麼開始學習？", "可以想一想獅子最後開始學認字。", "請寫出明確做法，不要只寫「我要努力」。"],
    ["如果別人沒有說出你真正的想法，你可以怎麼辦？", "可以寫用溫和的方式補充、說清楚自己的意思。", "請寫出你會怎麼說或怎麼做。"],
    ["如果同學不太會表達自己的想法，你可以怎麼幫助他？", "可以想一想母獅子怎麼聽獅子說話。", "請寫出一個友善又具體的幫忙方式。"],
  ],
};
...
function resolveThinkingGroups(
  ...
  if (key === "book3" || key === "3") return THINKING_GROUPS_BOOK3;

...
BOOK_PACK_BY_WEEK: dict[int, dict[str, Any]] = {
    ...
    3: {
        ...
        "version": 1,
        "rag_source": "file",
        "embedding_bundle_id": "week_3",
        "full_text_path": "/app/shared-data/book_pack_week3.json",
        "book_title": "朱家故事",
        "grade": "國小五年級",
        ...
        "characters": [
            ...
            {"name": "小吉", "role": "朱先生和朱太太的兒子，一開始每天催媽媽準備早飯和晚飯，朱太太不在時才學到要自己負責，之後幫忙鋪床"},
            {"name": "小利", "role": "朱先生和朱太太的另一個兒子，和小吉一起經歷家庭改變的過程，也幫忙鋪床"},
        ],
        "setting": ["朱家的花園洋房", "餐桌與廚房", "壁爐旁", "家中各個房間", "車庫"],
        "key_events": [
            "朱先生和兩個兒子小吉、小利住在漂亮的花園洋房裡，朱太太在家中忙著。",
            "每天早上，朱先生在出門上班前叫朱太太拿早飯；小吉和小利在出門上學前也催朱太太準備早飯。",
            "大家全出門後，朱太太清洗碗盤、鋪床、清掃房間，然後才出門上班。",
            "每天傍晚，孩子們放學後催朱太太準備晚飯；朱先生下班後也說餓死了要朱太太快點。",
            "一家人吃完飯，朱太太繼續洗碗、洗衣、燙衣服，再準備隔天的飯菜。",
            "有一天傍晚，孩子們放學回家，發現沒有人招呼他們；朱先生回家後找不到朱太太。",
            "朱先生在壁爐上找到一封信，打開後只有一張紙，上面寫著「你們是豬！」",
            "朱先生和孩子們不好意思自己做飯，但試了之後花很多小時，而且做得難吃極了。",
            "朱太太不在家的幾天裡，三人從不洗碗盤也從不洗衣服，家裡很快變得像豬圈一樣。",
            "有一天晚上家裡沒有東西吃，朱先生說要搜殘渣碎屑，就在這時朱太太走進門了。",
            "朱先生、小吉和小利哀求朱太太留下來，朱太太決定留下。",
            "之後朱先生幫忙洗碗盤和燙衣服，小吉和小利幫忙鋪床，大家一起做晚飯；朱太太也幫忙修好了車子。",
        ],
        "story_excerpts": [
            "這是朱先生和他的兩個兒子，小吉和小利。他們住在這幢很漂亮的花園洋房裏。朱太太正在房子裏忙著。",
            "「太太！快點！拿我的早飯來。」每天早上，朱先生在出門上班前，總會這樣叫。「媽！快點！早飯呢？」小吉和小利在出門上學前，總會這樣叫。",
            "他們全都出門以後，朱太太就開始清洗早餐留下的碗盤……鋪好每個人的床……清掃每個房間的地毯……然後才出門上班。",
            "「媽，快點！晚飯好了沒有？」每天傍晚，孩子們從學校回來，總會這樣叫。「老婆，快點！我餓死了！」每天傍晚，朱先生下班回來，總會這樣叫。",
            "他們一吃完飯，朱太太就洗碗……洗衣……燙衣服……然後，再準備明天的飯菜。",
            "有一天傍晚，孩子們放學回來，卻發現沒人招呼他們。「你媽呢？」朱先生一回到家就問。",
            "但是，他們哪兒都找不到朱太太。在壁爐上有一封信。朱先生拆開信封。信封裏有一張紙。你們是豬！",
            "他們不好意思自己做晚飯。這一做，就花了好多個小時，而且做得難吃極了。",
            "很快的，他們家就像個豬圈一樣。",
            "有一天晚上，家裏沒有東西吃了。朱先生說：「我們得搜搜看有沒有可吃的殘渣碎屑。」就是在這個時候，朱太太走進門了。",
            "「求求你留下來吧！」他們哀求著。",
            "於是，朱太太就留了下來。朱先生幫忙洗碗盤。小吉和小利鋪床。朱先生還燙了衣服。",
            "他們全都幫忙做晚飯。他們發現：大家一起動手做家事真開心。",
            "她幫忙修好了車子。",
        ],
        "orid_prompt_bank": {
            "O": [
                "故事一開始，朱先生、小吉和小利每天對朱太太說了哪些話？",
                "朱太太在大家出門後，做了哪些家事？",
                "有一天傍晚，小吉和小利放學回家後發現了什麼？",
                "朱先生在壁爐上找到什麼？那張紙上寫著什麼？",
                "朱太太不在家的幾天裡，朱先生和兩個孩子遇到了什麼困難？",
                "家裡後來變成什麼樣子？",
                "朱太太是在什麼情況下走進門的？",
                "朱太太留下來後，朱先生和兩個孩子分別幫忙做了哪些事？",
                "最後朱太太幫忙修好了什麼？",
            ],
            "R": [
                "看到朱太太每天清洗、鋪床、清掃、煮飯還要上班，你有什麼感覺？",
                "看到朱先生和孩子們一直催朱太太，你有什麼感覺，為什麼？",
                "看到朱太太留下「你們是豬！」這張紙條離開家，你覺得她可能有什麼心情？",
                "看到朱先生和孩子們自己做飯卻做得難吃極了，你有什麼感覺？",
                "看到他們哀求朱太太留下來，你有什麼感覺？",
                "看到最後大家一起做家事都很開心，你有什麼感覺？",
            ],
            "I": [
                "你覺得朱太太為什麼要留下那張紙條離開家？",
                "朱先生和孩子們後來可能明白了什麼？",
                "這個故事讓你想到家人之間應該怎麼互相對待？",
                "為什麼「大家一起動手做家事」會讓大家都開心？",
                "朱家後來的改變，和尊重家人有什麼關係？",
                "這個故事讓你想到自己家裡或班上的哪些情況？",
            ],
            "D": [
                "看完《朱家故事》後，你覺得自己在家裡可以做哪一件具體的事？",
                "如果你發現家人很忙，你可以怎麼幫忙？",
                "如果你以前曾經把別人的幫忙當成應該的，你以後可以怎麼改變？",
                "下次吃完飯後，你可以主動做一件什麼具體的事？",
                "如果你看到同學或家人辛苦做事，你可以怎麼表達感謝？",
                "你想從今天開始練習哪一個分擔責任的行動？",
            ],
        },
        "writing_guide": {
            "O": "先寫清楚故事裡誰做了什麼，讓別人看得懂事情怎麼發生。",
            "R": "寫出你看到故事事件後的感覺，也說說你為什麼有這種感覺。",
            "I": "想一想故事想提醒我們什麼，也可以連到自己的生活經驗。",
            "D": "寫出一個你真的可以做到的行動，不要只寫很大的口號。",
        },
        "writing_rubric": WEEK3_ORID_RUBRIC,
        "sel_rubric": WEEK3_SEL_RUBRIC,
        "grounding_facts": {
            "note_for_ai": "供 AI 內部 grounding 用，不直接引用給學生",
            "correct_facts": [
                "朱太太有出門上班（不只是家庭主婦）",
                "紙條上寫的是「你們是豬！」",
                "朱先生和孩子做的飯難吃極了（不是沒辦法做）",
                "最後朱太太幫忙修的是車子（不是房子或其他物品）",
                "朱先生幫忙洗碗盤和燙衣服；小吉和小利幫忙鋪床",
                "朱太太是自己走回家的（不是被找回來的）",
            ],
            "common_errors": [
                {"student_may_write": "朱太太一開始沒有工作", "correct": "朱太太做完家事後才出門上班"},
                {"student_may_write": "朱先生一開始就會幫忙做家事", "correct": "朱先生幫忙是故事後段的改變"},
                {"student_may_write": "紙條寫你們是家豬", "correct": "紙條寫「你們是豬！」"},
                {"student_may_write": "朱太太永遠離開家", "correct": "朱太太後來走回家，決定留下"},
                {"student_may_write": "最後媽媽修好了房子", "correct": "朱太太幫忙修好了車子"},
            ],
        },
    },
    # Week 4 uses the same book as week 3 (synthesis week)
...
DEFAULT_READING_CONTENT_BY_WEEK = {
